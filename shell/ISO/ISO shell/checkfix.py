...
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
	...
	'''
		...
		if key == "1":
			...
			os.system('bash /sbin/DB2_Check.sh')
...
'',
'',
'echo "server  35.1.7.19" >> /etc/ntp.conf ; echo "server 35.1.7.20" >> /etc/ntp.conf ',
'',
...
'LANG=C grep -E \'35.1.7.19|35.1.7.20\' > /dev/null 2>&1; if [ $? = 0 ];then echo 1 ;else echo 0 ;fi',
